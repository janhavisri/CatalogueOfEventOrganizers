  ...
  return (
    ...
    <div class="card-body p-md-5 text-black">
      ...
      <div class="row">
        <div class="col-md-6 mb-4">
          <div class="form-outline">
            <input type="text" id="firstname" class="form-control form-control-lg" placeholder="firstname" onChange={handleChange}
        ...
        <div class="col-md-6 mb-4">
          <div class="form-outline">
            <input type="text" id="lastname" class="form-control form-control-lg" placeholder="lastname" onChange={handleChange}
        ...
        <div class="col-md-6 mb-4">
          <div class="form-outline">
            <input type="text" id="organisationname" class="form-control form-control-lg" placeholder="organisation name"  onChange={handleChange}
      ...
      <div class="form-outline mb-4">
        <input type="text" id="registeredaddress" class="form-control form-control-lg" placeholder="address" onChange={handleChange}
...
<option value="">---Select City---</option>
      ...
      <div class="form-outline mb-4">
        <input type="text" id="postalcode" class="form-control form-control-lg"  placeholder="zip" onChange={handleChange}
